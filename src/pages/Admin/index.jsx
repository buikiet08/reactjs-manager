                ...
                <Col span={8} className="flex flex-col gap-4">
                    <div className="bg-white rounded-sm flex-1 flex flex-col">
                        <div className="w-full p-2 border-b border-solid border-b-gray-200">
                            <Typography.Title level={4} className="!mb-0 !tex-center">Nhân sự vắng</Typography.Title>
                        </div>
                        <div className="p-2 flex-1 flex justify-center items-center overflow-y-auto h-full max-h-[215px]">
                            không có dữ liệu
                        </div>
                    </div>
                    <div className="bg-white rounded-sm flex-1 h-full overflow-hidden">
                        ...
                        <div className="p-2 flex-1 overflow-y-auto h-full max-h-[215px]">
